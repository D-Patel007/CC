...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="en" suppressHydrationWarning>
      <body className="min-h-screen bg-blue-50 text-gray-900" suppressHydrationWarning>
        {/* Header */}
          ...
          <div className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
            ...
            <Link href="/" className="flex items-center gap-3 group">
              <img
                ...
                alt="Campus Connect"
                className="h-[55px] w-[55px] rounded-full border border-gray-300 group-hover:scale-105 transition-transform duration-150 object-cover"
              />
